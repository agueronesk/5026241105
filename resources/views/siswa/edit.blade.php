...
@section('konten')
    ...
    <a href="{{ route('siswa.index') }}" class="btn btn-secondary mb-4">
        Kembali
    </a>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="NRP" id="NRP" maxlength="10"
                            value="{{ old('NRP', $siswa->NRP) }}" class="form-control">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="Kelas" id="Kelas" maxlength="5"
                            value="{{ old('Kelas', $siswa->Kelas) }}" class="form-control">
                    </div>
                </div>

                <div class="row mb-3">
                    <label for="TanggalLahir" class="col-sm-2 col-form-label">
                        Tanggal Lahir
                    </label>

                    <div class="col-sm-10">
                        <input type="date" name="TanggalLahir" id="TanggalLahir"
                            value="{{ old('TanggalLahir', $siswa->TanggalLahir) }}" class="form-control">
                    </div>
                </div>
